...
<head>
  ...
  <title>HU ZUOQIN</title>

  <!-- CSS  -->
  <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
  <asset:stylesheet src="buildDest/main.css"/>
  <asset:stylesheet src="buildDest/materialize/materialize.css"/>
  <asset:stylesheet src="buildDest/pages/home.css"/>
...
<body>
  ...
  <div id="index-banner" class="parallax-container">
    ...
    <div class="parallax">
        <asset:image src="materialize/IMG_5228.jpg"/>
    </div>
  </div>
  ...
  <div class="parallax-container valign-wrapper">
    <div class="section no-pad-bot">
      <div class="container">
        <div class="row center">
          <h5 class="header col s12 light">I'm trilingual, fond of ballet, piano, books, films and watercolor painting etc.</h5>
        </div>
      </div>
    </div>
    <div class="parallax"><asset:image src="materialize/IMG_3221.jpg"/></div>
  </div>
  ...
  <div class="parallax-container valign-wrapper">
    ...
    <div class="parallax"><<asset:image src="materialize/IMG_2757.jpg"/></div>
  </div>
  ...
  <asset:javascript src="materialize/bin/materialize.js"/>
  <asset:javascript src="pages/home.js"/>
